        ...
        <div v-else>
            <div class="grid lg:grid-cols-5 gap-x-4">
                <div 
                    ...
                    class="min-h-screen"
                >
                    <div class="rounded bg-slate-700 py-1 px-2 xl:px-5 mb-2 text-center" :style="generateColumnStyle(index, data?.length)">
                        {{  column.name  }}
                    </div>
                    <div>
                        <KanbanCreateDeal 
                        ...
                        >
                            ...
                            <UiCardFooter>{{ dayjs(card.$createdAt).format('DD/MM/YYYY') }}</UiCardFooter>
                        </UiCard>
                    </div>
                </div>
            </div>
